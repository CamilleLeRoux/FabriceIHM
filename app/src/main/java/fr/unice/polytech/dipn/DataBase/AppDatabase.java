...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            Incident incident2 = new Incident("Inondation","Admin",2,43.615956, 7.072299,"O+999",3,"Un des robinets des toilettes est cassé ce qui provoque une inondation générale","26-04-2018",byteArray);
            Incident incident3 = new Incident("Rétroprojecteur défectueux","Admin",3,43.615451, 7.071805,"O+999",2,"Le rétroprojecteur emet un petit bruit toutes les dizaines de secondes","04-05-2018",byteArray);
            Incident incident4 = new Incident("Porte qui grince","François",1,44.3333,1.2167,"O+999",1,null,"01-05-2018",byteArray);
            Incident incident5 = new Incident("Manque de stylos","Camille",3,43.617130, 7.064327,"O+999",1,"Il n'y a plus de stylos bleu pour le tableau","02-05-2018",byteArray);
